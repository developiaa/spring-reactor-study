...
import pro.developia.reactor.dto.PostCreateRequest;
import pro.developia.reactor.dto.PostResponse;
import pro.developia.reactor.dto.PostResponseV2;
...
public class PostControllerV2 {
    ...
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<PostResponseV2>> deletePost(@PathVariable("id") Long id) {
